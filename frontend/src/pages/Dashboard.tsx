  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {uploadProgress > 0 && uploadProgress < 100 && (
        <div className="mt-4 w-full bg-gray-200 rounded-full h-2.5 shadow-inner">
          <div
            className="bg-[#4633FF] h-2.5 rounded-full transition-all"
